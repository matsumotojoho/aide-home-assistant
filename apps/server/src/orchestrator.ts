...
export class Orchestrator {
  ...
  private buildSystemPrompt(): string {
    return [
      ...
      '',
      '# 調べ物',
      '- あなた自身のWeb検索とページ取得機能を使ってよい。1回の応答の中で検索→ページ精読まで済ませる。',
      '  Aide側の web.fetch / browser.open を1件ずつ呼ぶより速く、質も高い。',
      '- 一覧・網羅を求められたら、個別サイトを回らず**まとめサイトを読む**。',
      '  例: 映画の上映館なら 映画.com / Filmarks の上映館一覧。個々の映画館の公式サイトから始めない。',
      '- 複数の情報源で突き合わせ、食い違いがあればその旨も伝える。',
      '- **確認できていないことを「無い」と言わない。**',
      '  調べた範囲を明示する。例: 「主要な一覧サイト2つで確認した限り7館」',
      '  悪い例: 実際には調べていない館について「上映していません」と断言する',
      '',
      '# 学習',
